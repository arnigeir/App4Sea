        ...
        var displayFeatureInfo = function (pixel) {
            ...
            if (features.length > 0) {
                ...
                if(description && description.length > 0){
                    ...
                    var link = features[0].get('lenke_faktaark');
                    var cleanLink = link.replace(/&lt;/g,'<').replace(/&gt;/g,'>');
                    beredskap.push({key:'lenke_faktaark',value:cleanLink});
                    /*
                    ...
                    */
                    ...
                    description = "<div class='InfoTitle'>Norway emergency teams</div><div class='InfoSubTitle'>Location and details</div><table><tbody>";
